...
local function unmute_by_reply(extra, success, result)
    ...
    if msg.to.type == 'chat' then
        send_msg('chat#id'..chat, '✴ '..lang_text(chat, 'userUnmuted:1')..' '..name..' ('..user..') '..lang_text(chat, 'userUnmuted:2'), ok_cb,  true)
    elseif msg.to.type == 'channel' then
        send_msg('channel#id'..chat, '✴ '..lang_text(chat, 'userUnmuted:1')..' '..name..' ('..user..') '..lang_text(chat, 'userUnmuted:2'), ok_cb,  true)
    end
end
...
local function mute_by_reply(extra, success, result)
    ...
    redis:set(hash, true)
    if msg.to.type == 'chat' then
        send_msg('chat#id'..chat, '✴ '..lang_text(chat, 'userMuted:1')..' '..name..' ('..user..') '..lang_text(chat, 'userMuted:2'), ok_cb,  true)
    elseif msg.to.type == 'channel' then
        send_msg('channel#id'..chat, '✴ '..lang_text(chat, 'userMuted:1')..' '..name..' ('..user..') '..lang_text(chat, 'userMuted:2'), ok_cb,  true)
    end
end
...
local function mute_by_username(cb_extra, success, result)
    ...
    if chat_type == 'chat' then
        send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'userMuted:1')..' '..user_username..' ('..user_id..') '..lang_text(chat_id, 'userMuted:2'), ok_cb,  true)
    elseif chat_type == 'channel' then
        send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'userMuted:1')..' '..user_username..' ('..user_id..') '..lang_text(chat_id, 'userMuted:2'), ok_cb,  true)
    end
end
...
local function unmute_by_username(cb_extra, success, result)
    ...
    redis:del(hash)
    if chat_type == 'chat' then
        send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'userMuted:1')..' '..user_username..' ('..user_id..') '..lang_text(chat_id, 'userUnmuted:2'), ok_cb,  true)
    elseif chat_type == 'channel' then
        send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'userMuted:1')..' '..user_username..' ('..user_id..') '..lang_text(chat_id, 'userUnmuted:2'), ok_cb,  true)
    end
end
...
local function chat_kick(extra, success, result)
    ...
    if chat_type == 'chat' then
        ...
        send_msg('chat#id'..chat, '✴ '..lang_text(chat, 'kickUser:1')..' '..user..' '..lang_text(chat, 'kickUser:2'), ok_cb,  true)
    elseif chat_type == 'channel' then
        channel_kick_user('channel#id'..chat, 'user#id'..user, ok_cb, false)
        send_msg('channel#id'..chat, '✴ '..lang_text(chat, 'kickUser:1')..' '..user..' '..lang_text(chat, 'kickUser:2'), ok_cb,  true)
    end
end
...
local function chat_ban(extra, success, result)
    ...
    redis:set(hash, true)
    chat_del_user('chat#id'..chat, 'user#id'..user, ok_cb, false)
    send_msg('chat#id'..chat, '✴ '..lang_text(chat, 'banUser:1')..' '..user..' '..lang_text(chat, 'banUser:2'), ok_cb,  true)
end
...
local function gban_by_reply(extra, success, result)
    ...
    if msg.to.type == 'chat' then
        chat_del_user('chat#id'..chat, 'user#id'..user, ok_cb, false)
        send_msg('chat#id'..chat, '✴ '..lang_text(chat, 'gbanUser:1')..' '..user..' '..lang_text(chat, 'gbanUser:2'), ok_cb,  true)
    elseif msg.to.type == 'channel' then
        channel_kick_user('channel#id'..chat, 'user#id'..user, ok_cb, false)
        send_msg('channel#id'..chat, '✴ '..lang_text(chat, 'gbanUser:1')..' '..user..' '..lang_text(chat, 'gbanUser:2'), ok_cb,  true)
    end
end
...
local function ungban_by_reply(extra, success, result)
    ...
    if msg.to.type == 'chat' then
        ...
        send_msg('chat#id'..chat, '✴ '..lang_text(chat, 'ungbanUser:1')..' '..user..' '..lang_text(chat, 'ungbanUser:2'), ok_cb,  true)
    elseif msg.to.type == 'channel' then
        channel_invite_user('channel#id'..chat, 'user#id'..user, ok_cb, false)
        send_msg('channel#id'..chat, '✴ '..lang_text(chat, 'ungbanUser:1')..' '..user..' '..lang_text(chat, 'ungbanUser:2'), ok_cb,  true)
    end
end
...
local function add_by_reply(extra, success, result)
    ...
    if msg.to.type == 'chat' then
        chat_add_user('chat#id'..chat, 'user#id'..user, ok_cb, false)
        send_msg('chat#id'..chat, '✴ '..lang_text(chat, 'addUser:1')..' '..user..' '..lang_text(chat, 'addUser:2'), ok_cb,  true)
    elseif msg.to.type == 'channel' then
        channel_invite_user('channel#id'..chat, 'user#id'..user, ok_cb, false)
        send_msg('channel#id'..chat, '✴ '..lang_text(chat, 'addUser:1')..' '..user..' '..lang_text(chat, 'addUser:3'), ok_cb,  true)
    end
end
...
local function channel_ban(extra, success, result)
    ...
    send_msg('channel#id'..chat, '✴ '..lang_text(chat, 'banUser:1')..' '..user..' '..lang_text(chat, 'banUser:2'), ok_cb,  true)
    ban_user(user, chat)
end
...
local function ban_by_username(cb_extra, success, result)
    ...
    redis:set(hash, true)
    if chat_type == 'chat' then
        send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'banUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'banUser:2'), ok_cb, false)
        chat_del_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    elseif chat_type == 'channel' then
        send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'banUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'banUser:2'), ok_cb, false)
...
local function kick_by_username(cb_extra, success, result)
    ...
    user_username = result.username
    if chat_type == 'chat' then
        send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'kickUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'kickUser:2'), ok_cb, false)
        chat_del_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    elseif chat_type == 'channel' then
        send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'kickUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'kickUser:2'), ok_cb, false)
        channel_kick_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    end
end
...
local function gban_by_username(cb_extra, success, result)
    ...
    if chat_type == 'chat' then
        send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'gbanUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'gbanUser:2'), ok_cb, false)
        chat_del_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    elseif chat_type == 'channel' then
        send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'gbanUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'gbanUser:2'), ok_cb, false)
        channel_kick_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    end
end
...
local function ungban_by_username(cb_extra, success, result)
    ...
    if chat_type == 'chat' then
        send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'ungbanUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'ungbanUser:2'), ok_cb, false)
        chat_add_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    elseif chat_type == 'channel' then
        send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'ungbanUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'ungbanUser:2'), ok_cb, false)
...
local function unban_by_username(cb_extra, success, result)
    ...
    redis:del(hash)
    if chat_type == 'chat' then
        send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'unbanUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'unbanUser:2'), ok_cb, false)
        chat_add_user('chat#id'..chat_id, 'user#id'..user_id, callback, false)
    elseif chat_type == 'channel' then
        send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'unbanUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'unbanUser:2'), ok_cb, false)
...
local function add_by_username(cb_extra, success, result)
    ...
    print(chat_id)
    if chat_type == 'chat' then
        send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'addUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'addUser:2'), ok_cb, false)
        chat_add_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    elseif chat_type == 'channel' then
        send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'addUser:1')..' @'..user_username..' ('..user_id..') '..lang_text(chat_id, 'addUser:3'), ok_cb, false)
        channel_invite_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
    end
end
    ...
    if matches[1] == 'ban' then
        if permissions(msg.from.id, msg.to.id, "ban") then
            ...
            if not is_id(matches[2]) then
                ...
                user_id = matches[2]
                if chat_type == 'chat' then
                    send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'banUser:1')..' '..user_id..' '..lang_text(chat, 'banUser:2'), ok_cb, false)
                    chat_del_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                elseif chat_type == 'channel' then
                    send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'banUser:1')..' '..user_id..' '..lang_text(chat, 'banUser:2'), ok_cb, false)
                    channel_kick_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                end
                ban_user(user_id, chat_id)
                return
    ...
    elseif matches[1] == 'unban' then
        if permissions(msg.from.id, msg.to.id, "unban") then
            ...
            if not is_id(matches[2]) then
                ...
                return '✴ '..lang_text(chat_id, 'unbanUser:1')..' '..matches[2]..' '..lang_text(chat_id, 'unbanUser:2')
            end
        else
            return '✖ '..lang_text(msg.to.id, 'require_mod')
        end
    elseif matches[1] == 'kick' then
        if permissions(msg.from.id, msg.to.id, "kick") then
            ...
            if not is_id(matches[2]) then
                ...
                if msg.to.type == 'chat' then
                    send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'kickUser:1')..' '..user_id..' '..lang_text(chat_id, 'kickUser:2'), ok_cb, false)
                    chat_del_user('chat#id'..msg.to.id, 'user#id'..matches[2], ok_cb, false)
                elseif msg.to.type == 'channel' then
                    send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'kickUser:1')..' '..user_id..' '..lang_text(chat_id, 'kickUser:2'), ok_cb, false)
    ...
    elseif matches[1] == 'gban' then
        if permissions(msg.from.id, msg.to.id, "gban") then
            ...
            if not is_id(matches[2]) then
                ...
                if chat_type == 'chat' then
                    send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'gbanUser:1')..' '..user_id..' '..lang_text(chat_id, 'gbanUser:2'), ok_cb, false)
                    chat_del_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                elseif chat_type == 'channel' then
                    send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'gbanUser:1')..' '..user_id..' '..lang_text(chat_id, 'gbanUser:2'), ok_cb, false)
                    channel_kick_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                end
                return
            end
    ...
    elseif matches[1] == 'ungban' then
        if permissions(msg.from.id, msg.to.id, "ungban") then
            ...
            if not is_id(matches[2]) then
                ...
                if chat_type == 'chat' then
                    send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'gbanUser:1')..' '..user_id..' '..lang_text(chat_id, 'ungbanUser:2'), ok_cb, false)
                    chat_add_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                elseif chat_type == 'channel' then
                    send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'gbanUser:1')..' '..user_id..' '..lang_text(chat_id, 'ungbanUser:2'), ok_cb, false)
                    channel_invite_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                end
                return
            end
    ...
    elseif matches[1] == 'add' then
        if permissions(msg.from.id, msg.to.id, "add") then
            ...
            if not is_id(matches[2]) then
                ...
                local user_id = matches[2]
                if chat_type == 'chat' then
                    send_msg('chat#id'..chat_id, '✴ '..lang_text(chat_id, 'addUser:1')..' '..user_id..' '..lang_text(chat_id, 'addUser:2'), ok_cb, false)
                    chat_add_user('chat#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                elseif chat_type == 'channel' then
                    send_msg('channel#id'..chat_id, '✴ '..lang_text(chat_id, 'addUser:1')..' '..user_id..' '..lang_text(chat_id, 'addUser:3'), ok_cb, false)
                    channel_invite_user('channel#id'..chat_id, 'user#id'..user_id, ok_cb, false)
                end
                return
            end
        ...
        if permissions(msg.from.id, msg.to.id, "mute") then
            ...
            if matches[2] then
                if is_id(matches[2]) then
                    ...
                    redis:set(hash, true)
                    if msg.to.type == 'chat' then
                        send_msg('chat#id'..msg.to.id, '✴ '..lang_text(chat_id, 'userMuted:1')..' '..matches[2]..' '..lang_text(chat_id, 'userMuted:2'), ok_cb, true)
                    elseif msg.to.type == 'channel' then
                        send_msg('channel#id'..msg.to.id, '✴ '..lang_text(chat_id, 'userMuted:1')..' '..matches[2]..' '..lang_text(chat_id, 'userMuted:2'), ok_cb, true)
                    end
                    return
                else
                    local member = string.gsub(matches[2], '@', '')
        ...
        if permissions(msg.from.id, msg.to.id, "unmute") then
            ...
            if matches[2] then
                if is_id(matches[2]) then
                    ...
                    redis:del(hash)
                    if msg.to.type == 'chat' then
                        send_msg('chat#id'..msg.to.id, '✴ '..lang_text(chat_id, 'userUnmuted:1')..' '..matches[2]..' '..lang_text(chat_id, 'userUnmuted:2'), ok_cb, true)
                    elseif msg.to.type == 'channel' then
                        send_msg('channel#id'..msg.to.id, '✴ '..lang_text(chat_id, 'userUnmuted:1')..' '..matches[2]..' '..lang_text(chat_id, 'userUnmuted:2'), ok_cb, true)
                    end
                    return
                else
                    local member = string.gsub(matches[2], '@', '')
